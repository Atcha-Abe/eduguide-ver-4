        ...
        return (
            <div align="center">
                ...
                <div className="question">
                    ...
                    <label className="gen-label">Do you like Computers?
                        <span class="checkmark"></span>
                    </label>
                <div className="options" align="left">
                    <input type="radio" className="gen-input"/>
                    <label className="gen-label">Programming
                    </label>
                    <br></br>
                    <input type="radio" className="gen-input"/>
                    <label className="gen-label">Video Editing
                    </label>
                    <br></br>
                    <input type="radio" className="gen-input"/>
                    <label className="gen-label">Gaming
                    </label>
                    <br></br>
                    <input type="radio" className="gen-input"/>
                    <label className="gen-label">Building
                    </label>
                </div>
                </div>
                <div className="result-btn">
                        <Link to="/mainprofile" className="reg-btn" value="Save">Back</Link>
                        <Link to="/genresults" className="reg-btn" value="Next">Next</Link>
                </div>
