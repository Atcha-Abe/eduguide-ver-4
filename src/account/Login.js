    ...
    return (
        ...
        <div align="center">
            ...
            <form align="left" className="sign-form">
                <label> 
                <b>Username:</b>
                    <input type="text" className="field" name="uname" value={userDetails} onChange={handleChange} />
                </label>
                <br></br>
                <label>
                <b>Password:</b>
            ...
            <br></br>
            <Link to="/welcome" className="reg-btn" value="Log In" onClick={handleLogin}>Log In</Link>
