        ...
        return (
            <div>
                ...
                <div  className="about__link">
                    <li><Link to="/authors" className="about__link" >Authors</Link></li>
                    <li><Link to="/system" className="about__link" >System</Link></li>
                </div>
                    ...
                    <table className="intro-edu">
                        <tr>
                            <td>
                                ...
                                <br></br> 
                                These tests will help narrow down the programs to choose from.</p>
                            </td>
                            <td>
